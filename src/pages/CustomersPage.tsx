            ...
            <div className="space-y-4">
              <div className="card-surface p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="p-3 rounded-lg" style={{ backgroundColor: "#0A0A0B" }}><div className="flex items-center gap-2 text-[#8A8B8C] text-xs mb-1"><Tag className="w-3 h-3" /> Payment Terms</div><div className="text-white text-sm font-body">{(selected.paymentTerms || "cod").replace("_", " ").toUpperCase()}</div></div>
