...
export const appRouter = t.router({
  ...
  order: t.router({
    ...
    convertQuoteToOrder: t.procedure.input((val: unknown) => val as { quoteId: number }).mutation(() => ({} as any)),
  }),
  invoice: t.router({
    list: t.procedure.query(() => [] as any[]),
    getById: t.procedure.input((val: unknown) => val as number).query(() => null as any),
    ...
    allocateCredit: t.procedure.input((val: unknown) => val as any).mutation(() => ({} as any)),
