...
export const customers = mysqlTable("customers", {
  ...
  salesRepName: varchar("salesRepName", { length: 100 }),
...
export const orders = mysqlTable("orders", {
  ...
  status: mysqlEnum("status", ["pending", "picking", "ready", "delivered", "cancelled", "sample_delivered"]).default("pending").notNull(),
  orderType: mysqlEnum("orderType", ["regular", "sample"]).default("regular").notNull(),
  paymentTerms: mysqlEnum("paymentTerms", ["cod", "7_days", "14_days", "30_days"]).default("cod").notNull(),
  priceTier: mysqlEnum("priceTier", ["corporate", "bulk", "wholesale", "retail"]).default("wholesale").notNull(),
