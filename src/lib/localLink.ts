        ...
        (async () => {
          try {
            ...
            switch (path) {
              ...
              // STOCK — return local immediately; subscription keeps it synced
              ...
              // CUSTOMERS — return local immediately; subscription keeps it synced
              ...
              // ORDERS — return local immediately; subscription keeps it synced
              ...
              // INVOICES — return local immediately; subscription keeps it synced
              ...
              // USERS — return local immediately; subscription keeps it synced
              ...
              // APPOINTMENTS — return local immediately; subscription keeps it synced
              ...
              // CHECKINS — return local immediately; subscription keeps it synced
              ...
              // FOLLOW-UPS — return local immediately; subscription keeps it synced
